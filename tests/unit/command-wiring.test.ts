...
describe('Command Wiring', () => {
  ...
  describe('initialization', () => {
    it('creates a router with all 30 commands registered', () => {
      ...
      expect(commands).toContain('tune');
      expect(commands).toContain('tune-and-chart');
      expect(commands).toContain('tune-pipeline');
      expect(commands).toContain('scan');
      expect(commands).toContain('chart');
      expect(commands).toContain('scan-chart');
      expect(commands).toContain('v3');
      expect(commands).toContain('journal-status');
      expect(commands).toContain('journal-record');
      expect(commands).toContain('journal-update');
      expect(commands).toContain('regime');
      expect(commands).toContain('signal-history');
      expect(commands).toContain('sentiment-check');
      expect(commands).toContain('generate-backtest-manifest');
    });
