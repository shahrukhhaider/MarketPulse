...
import { getDefaultCompositeConfig, isV2Config, type CompositeStrategyParams, type PhasedStrategyParams } from './strategies/strategy-configs.js';
...
import { buildConfig, buildV2Config, generateV2Grid } from './parameter-grid.js';
