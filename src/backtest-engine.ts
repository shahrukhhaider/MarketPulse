...
import type { PhasedStrategyParams, ConsolidationBreakoutParams, TrendPullbackParams } from './strategies/strategy-configs.js';
...
export class BacktestEngine {
  ...
  runV2(
    ...
    params: PhasedStrategyParams | ConsolidationBreakoutParams | TrendPullbackParams,
    period: string = '1y'
  ): BacktestResult {
    engine.reset();
